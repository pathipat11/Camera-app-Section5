...
export default function App() {
  ...
  if (!cameraPermission) return <View style={styles.center}><Text>Requesting camera permission...</Text></View>;
  if (!hasMediaLibraryPermission) return <View style={styles.center}><Text>Requesting media library permission...</Text></View>;
      ...
      <Modal visible={galleryVisible} animationType="slide">
        <SafeAreaView style={styles.galleryContainer}>
          <View style={styles.galleryHeader}>
            ...
            <TouchableOpacity onPress={() => { setGalleryVisible(false); loadGallery(); }}>
...
const styles = StyleSheet.create({
  ...
  actionRow: { flexDirection: "row", justifyContent: "space-around", backgroundColor: "#111", padding: 20 },
  controlButton: { alignItems: "center" },
  text: { color: "#fff", marginTop: 5 },

  // Gallery
  galleryContainer: { flex: 1, backgroundColor: "#000" },
  galleryHeader: { flexDirection: "row", justifyContent: "space-between", padding: 15, alignItems: "center" },
  galleryTitle: { color: "#fff", fontSize: 18, fontWeight: "bold" },
  galleryImage: { width: "33%", height: 120, borderWidth: 1, borderColor: "#111" },
});
